...
*/
class Ut_des : public Ut_fixture
{
...
/** @brief Test of invalidation on DES reconfiguration
 * */
void Ut_des::test_des_inval_1()
{
    cout << endl << "=== Test of invalidation on DES reconfiguration ===" << endl;

    const string specn("ut_des_inval_1");
    string ext = "chs";
    MNode* root = constructSystem(specn);
    MElem* eroot = root ? root->lIf(eroot) : nullptr;
    CPPUNIT_ASSERT_MESSAGE("Fail to get root", eroot);
...
/** @brief Test of invalidation on DES reconfiguration
 * */
void Ut_des::test_des_inval_2()
{
    cout << endl << "=== Test of invalidation on DES reconfiguration: minimize ===" << endl;

    MNode* root = constructSystem("ut_des_inval_2");
 ...
 * */
void Ut_des::test_des_sock_2()
{
    cout << endl << "=== Test#2 of connection topology in DES ===" << endl;

    MNode* root = constructSystem("ut_des_sock_2");
