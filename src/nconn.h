 ...
 * */
template <class TPif, class TRif>
class NCpOmip : public MNcp<TPif, TRif>
{
    public:
	using TThis = NCpOmip<TPif, TRif>;
	using TSelf= typename MNcp<TPif, TRif>::TSelf;
 ...
 * */
template <class TPif, class TRif>
class NCpOmnp : public MNcp<TPif, TRif>
{
    public:
 ...
 * */
template <class TPif, class TRif>
class NCpOnp : public MNcp<TPif, TRif>
{
    public:
	using TSelf= typename MNcp<TPif, TRif>::TSelf;
...
class NTnnp : public NCpOnp<TProv, TReq>
{
	...
	using TScp = NCpOnp<TProv, TReq>;  /*!< Self connpoint type */
	using TPair = typename TScp::TPair;
	using TNodeIf = MNcp<TProv, TReq>; /*!< Node (pole) iface type */
	using TCnodeIf = MNcp<TReq, TProv>; /*!< Complement node (pole) type */
