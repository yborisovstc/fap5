#ifndef __FAP5_PROV_H
#define __FAP5_PROV_H
...
class Provider: public MProvider
{
	...
	string MProvider_Uid() const override { return mName;};
	MIface* MProvider_getLif(TIdHash aId) override;
